#!/bin/bash
# create_thimbly_pack.sh - Generates Thimbly CP1 pack & zips it

set -e
mkdir -p thimbly/docs
cd thimbly

# 00_MASTER_CONTEXT.md
cat > docs/00_MASTER_CONTEXT.md << 'EOF'
...
# 01_TASK_SUPABASE_FOUNDATION.md
cat > docs/01_TASK_SUPABASE_FOUNDATION.md << 'EOF'
...
# 02_TASK_WORKER_SKELETON.md
cat > docs/02_TASK_WORKER_SKELETON.md << 'EOF'
...
# 03_TASK_GRID_ENGINE.md
cat > docs/03_TASK_GRID_ENGINE.md << 'EOF'
...
# 04_TASK_INTEGRATION_FLOW.md
cat > docs/04_TASK_INTEGRATION_FLOW.md << 'EOF'
...
# 05_VALIDATION_PROTOCOL.md
cat > docs/05_VALIDATION_PROTOCOL.md << 'EOF'
...
# 06_COMPLETION_CHECKLIST.md
cat > docs/06_COMPLETION_CHECKLIST.md << 'EOF'
...
# ZIP IT
cd ..
zip -r thimbly_cp1_pack.zip thimbly/
echo "✅ thimbly_cp1_pack.zip created successfully."